package com.pagehelperlearning.dao;

import com.pagehelperlearning.pojo.Consumer;
import com.pagehelperlearning.provider.ConsumerProvider;
import com.pagehelperlearning.provider.ConsumerProvider2;
...
public interface ConsumerDao {
    ...
    @Results(id = "consumerToDB", value = {
            ...
            @Result(property = "consumerName", column = "name", javaType = String.class),
